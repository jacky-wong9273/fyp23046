...
import MetamarkComponent from "../metamask/MetamarkComponent.tsx";
        ...
        <div className="flex items-center px-6 py-6 xl:px-24 ">
          ...
          <div className="js-mobile-menu invisible lg:visible fixed inset-0 z-10 ml-auto rtl:mr-auto rtl:ml-0 items-center bg-white opacity-0 dark:bg-jacarta-800 lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent ">
            ...
            <div className="ml-8  hidden lg:flex xl:ml-12">
              {/* Wallet */}
              <MetamarkComponent>
                <div className="dark:text-white font-semibold cursor-pointer js-dark-mode-trigger group ml-2 flex h-10 w-[8rem] items-center justify-center rounded-full border border-jacarta-100 bg-white transition-colors hover:border-transparent hover:bg-accent focus:border-transparent focus:bg-accent dark:border-transparent dark:bg-white/[.15] dark:hover:bg-accent">
                  Connect
                </div>
              </MetamarkComponent>

      ...
      <div className="container">
        ...
        <div className="article-content mx-auto max-w-[48.125rem]">
          ...
          <p>
            ...
            the FYP23046 website(s), our APIs, mobile app (the “App”), and any
            ...
            similar digital item implemented on a blockchain (such as the Solana
            blockchain), which uses smart contracts to link to or otherwise be
            associated with certain content or data. For purposes of these
            Terms, “user”, “you”, and “your” means you as the user of the
            Service. If you use the Service on behalf of a company or other
          ...
          <p>
            FYP23046 is not a wallet provider, exchange, broker, financial
            institution, or creditor. FYP23046 provides a peer-to-peer web3
          ...
          <p>
            ...
            FYP23046 logo and all designs, text, graphics, pictures, data,
            software, sound files, other files, and the selection and
            arrangement thereof are the proprietary property of FYP23046 or our
          ...
          <p>
            These Terms constitute the entire agreement between you and FYP23046
            ...
            assigned by you without the prior written consent of FYP23046, and
            FYP23046’s failure to assert any right or provision under these
          ...
          <p>
            ...
            applicable local laws. You and FYP23046 agree that the United
